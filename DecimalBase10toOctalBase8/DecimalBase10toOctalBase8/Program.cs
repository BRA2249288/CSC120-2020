...
namespace DecimalBase10toOctalBase8
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var total = "10";
            var result = ConvertToBase10("100", 8, total, 100); 
        ...
        private static object ConvertToBase10(string value, int fromBase, string characters, int maxFromSchemeCharacter)
        {
